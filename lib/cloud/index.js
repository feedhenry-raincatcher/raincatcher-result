...
module.exports = function(mediator) {
   ...
   */
  resultCloudTopics.on('create', function(resultToCreate) {
    ...
    return resultCloudDataTopics.request('create', resultToCreate);
  });
  ...
  resultCloudTopics.on('list', function(listOptions) {
    ...
    return resultCloudDataTopics.request('list', listOptions.filter);
  });
  ...
  resultCloudTopics.on('update', function(resultToUpdate) {
    ...
    return resultCloudDataTopics.request('update', resultToUpdate);
  });
